...
function InstagramFeed() {
    let instLink = "https://www.instagram.com/p/Cf_zag3uk3P/?utm_source=ig_embed&amp;utm_campaign=loading";
    useEffect(() => {
    ...
    return(
        <div>
            <blockquote className="instagram-media" data-instgrm-permalink={instLink} data-instgrm-version="14" style={{ background:'#FFF', border:0, borderRadius:'3px', boxShadow:'0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth:'540px', minWidth:'326px', padding:0, width:'99.375%', width:'-webkit-calc(100% - 2px)', width:'calc(100% - 2px)',}}>
            <div style={{padding:'16px',}}>
                <a href={instLink} style={{ background:'#FFFFFF', lineHeight:0, padding:'0 0', textAlign:'center', textDecoration:'none', width:'100%',}} target="_blank" rel="noreferrer">
                    ...
                    <div style={{paddingTop: '8px',}}>
                        <div style={{ color:'#3897f0', fontFamily:'Arial,sansSerif', fontSize:'14px', fontStyle:'normal', fontWeight:550, lineHeight:'18px',}}>View this post on Instagram</div>
                    </div>
                ...
                <p style={{ color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', lineHeight:'17px', marginBottom:0, marginTop:'8px', overflow:'hidden', padding:'8px 0 7px', textAlign:'center', textOverflow:'ellipsis', whiteSpace:'nowrap',}}>@<a href={instLink} style= {{color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', fontStyle:'normal', fontWeight:'normal', lineHeight:'17px',}} target="_blank" rel="noreferrer">raccoonlabs</a> • Instagram photos and videos</p>
            </div>
            </blockquote>
